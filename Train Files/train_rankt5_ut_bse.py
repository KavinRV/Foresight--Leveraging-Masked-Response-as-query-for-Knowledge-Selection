...
tokenized_wow = DatasetDict.load_from_disk("wow_rank_ut_base")
tokenized_wow.set_format(type="torch", columns=["input_ids", "attention_mask", "pass_label"])
# tok_valid = 
...
#             loss_fct1 = nn.KLDivLoss(reduction="batchmean")
            ...
            loss = loss_fct(rank_score, pass_label.view(-1))
...
# t = 2
model_dir = f"wow_rank_{mod_ckp}_ut"
