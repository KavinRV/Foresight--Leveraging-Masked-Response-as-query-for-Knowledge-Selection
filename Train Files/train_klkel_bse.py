...
# t = 2
# model_dir = f"{mod_ckp[:-6]}_rank_0to50_kld_tem:T{model.config.temp1}S{model.config.temp2}"
model_dir = f"wow_pre_rank_0to50_kld_tem:T{model.config.temp1}S{model.config.temp2}"
